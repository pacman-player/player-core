...
$(document).on('click', '.addGenreToFilter', function addGenreToFilter() {
    ...
    $.ajax({
        method: 'post',
        url: banned ? '/api/v1/user/genre/genreUnBan' : '/api/user/genre/genreBan',
        contentType: "application/json",
...
$authorForms.on("submit", function (searchAuthor) {
    ...
    $.ajax({
        type: 'get',
        url: '/api/v1/author/allAuthorsByName/' + authorName,
        contentType: 'application/json;',
...
$(document).on('click', '.addAuthorToFilter', function addAuthorToFilter() {
    ...
    $.ajax({
        method: 'post',
        url: banned ? '/api/v1/author/authorsUnBan' : '/api/author/authorsBan',
        contentType: "application/json",
...
$musicForm.on("submit", function (searchMusics) {
    ...
    $.ajax({
        type: 'get',
        url: '/api/v1/music/allSongsByName/' + musicName,
        contentType: 'application/json;',
...
$(document).on('click', '.addMusicToFilter', function addMusicToFilter() {
    ...
    $.ajax({
        method: 'post',
        url: banned ? "/api/v1/music/songsUnBan" : '/api/music/songsBan',
        contentType: "application/json",
