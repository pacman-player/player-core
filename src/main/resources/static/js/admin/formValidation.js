...
$(document).ready(function () {
    ...
    $('#updateUserPass').focusout(function () {
        ...
        if (result === null) {
            message = "Пароль должен содержать минимум 6 символов, включать цифры, заглавные и строчные буквы";
...
$('#addForm').validate({
    ...
    messages: {
        ...
        password: {
            minlength: "Пароль должен содержать минимум 6 символов, включать цифры, заглавные и строчные буквы",
            pattern: "Пароль должен содержать минимум 6 символов, включать цифры, заглавные и строчные буквы",
            required: "Введите пароль"
        },
        role: {
            required: "Необходимо выбрать роль для пользователя"
        },
        company: {
