...
$(document).ready(function () {
    ...
    $('#updateUserPass').focusout(function () {
        ...
        if (result === null) {
            message = "Пароль должен содержать минимум 6 символов, включать цифры и буквы в разном регистре";
...
$('#addForm').validate({
    ...
    messages: {
        ...
        password: {
            minlength: "Пароль должен содержать минимум 6 символов, включать цифры и буквы в разном регистре",
            pattern: "Пароль должен содержать минимум 6 символов, включать цифры и буквы в разном регистре",
