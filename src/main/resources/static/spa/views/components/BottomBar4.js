//этот вариант проигрывает музыку, но при переходе по вкладкам меню - музыка останавливается
...
// функция для изменения изображения и data-playing_state на кнопке при остановке музыки
         ...
         */
        window.playOrPause = function(playlistName, compilationIndex, musicIndex, isFromSongQueue) {
