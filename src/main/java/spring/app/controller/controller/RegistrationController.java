...
public class RegistrationController {
    ...
    @GetMapping("/second")
    public String getSecondRegistrationPage(@RequestParam String login, Model model, HttpServletResponse response, HttpSession httpSession) {
...
//        Cookie cookie = new Cookie("firstRegistrationStepDone", login);
        Cookie cookie = new Cookie("secondRegistrationStepDone", login);
        cookie.setMaxAge(0);
